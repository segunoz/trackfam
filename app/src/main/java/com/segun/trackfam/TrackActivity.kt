        ...
        override fun onDataChange(dataSnapshot: DataSnapshot) {
            if (dataSnapshot.exists()) {
                ...
                if (partnerLat != null && partnerLong != null) {
                    ...
                    map.addMarker(markerOptions.title("Emmanuel").icon(
            ...
            override fun onLocationResult(locationResult: LocationResult) {
                if (locationResult.locations.isNotEmpty()) {
                    ...
                    if (location != null) {
                        ...
                        map.clear()
                        map.addMarker(markerOptions.title("segun").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)))
...
//this will enable to view the locations of all the parties
fun trackAll(){

}

//this will enable the user to view the current location of the particular person to be visited
fun trackPerson(){
